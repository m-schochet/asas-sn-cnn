...
# The variable `save_path` is the location on your device for where to save the quiescent light curves. Insert your own respective save path here to store the light curves
